        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverFilePath = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistSocialMedias", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SingleTracks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SingleTracks_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SingleTracks_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistSocialMedias_ArtistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SingleTracks_ArtistId",
                table: "SingleTracks",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_SingleTracks_TrackId",
                table: "SingleTracks",
                column: "TrackId",
                unique: true);
